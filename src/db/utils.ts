...
const linkGenshinAccountToUser = async (providerId: string, uid: string, name?: string): Promise<GenshinAccount> => {
...
export { getUserFromProvider, createUser, linkGenshinAccountToUser, createWishSave, getLatestWishFromGenshinAccount, getGenshinAccountFromUid, getGenshinAccountsFromUser, getWishesFromGenshinAccount }
